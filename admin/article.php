                            ...
                            <div class="p-5">
                                ...
                                <form class="user" role="form" id="form_article" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2" id="category_id" name="category_id"
                                    ...
                                    <div class="form-group">
                                        <label for="titre_article">Titre de votre article</label><input type="text"
                                                                                                        class="form-control"
                                                                                                        id="titre_article"
                                                                                                        name="titre_article"
                                                                                                        aria-describedby="titre_article"
                                  ...
                                  <span class="btn btn-default btn-file">Selectionner une image…
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="desc_article" id="desc_article" class="form-control" cols="30"
                                    ...
                                    <div class="form-group">
                                        <h3 class="sidebar-title"
                                            style="font-size: 20px;font-weight: 700;padding: 0 0 0 0;margin: 0 0 15px 0;color: #2b2320;position: relative;">
                                            Tags</h3>
                                        <div class="sidebar-item tags" style="margin-bottom: -10px;">
                                            <ul style="list-style: none;padding: 0;margin-top: 0;margin-bottom: 1rem;">
                                                ...
                                                foreach (App::getDB()->query('SELECT * FROM tags') as $tag):
                                                    echo '<li style="display: inline-block;"><a style="color: #745f56;
font-size: 14px;
padding: 6px 14px;
margin: 0 6px 8px 0;
...
transition: 0.3s;
border-radius: 4px;" href="#" onclick="addID('.$tag->id.');return false;">' . $tag->title . '</a></li>';
                                                endforeach;
                                                ?>
                                            </ul>
                                    ...
                                    <div class="form-group">
                                        <input style="font-size: 15px" type="submit"
                                               class="btn btn-primary btn-user btn-block currentSend" value="Publier"/>
                                        <center><img src="img/loader.gif" class="loader" style="display:none;" alt="">
                                        </center>
                                    </div>
...
========================================================================== */
    ...
    $(function () {
        ...
        $('#form_article').on('submit', function (e) {
            ...
            //tabTag.forEach(element => console.log(element));
            ...
            $.ajax({
                url: 'controllers/traitement.php?article=' + tabTag,
                type: 'post',
...
<script>
    $(function () {
        $('.tags ul a').click(function () {
            if ($(this).hasClass('pipo-item')) {
                $(this).removeClass('pipo-item');
            } else {
                $(this).addClass('pipo-item');
            }
        });
    });
